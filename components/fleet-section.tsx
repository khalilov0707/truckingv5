...
const fleetItems = [
  ...
  },
  {
    ...
    description: "Temperature-controlled trailers for perishable goods, maintaining product integrity during transit.",
    features: ["Precise temperature control", "53' length capacity", "Multi-temperature zones available"],
    image: "/placeholder.svg?height=400&width=600",
  },
  {
    id: "flatbed",
    title: "Flatbed Trailers",
    description: "Open trailers for oversized or irregularly shaped cargo that requires special loading or securing.",
    features: ["48' to 53' length options", "Up to 48,000 lbs capacity", "Versatile loading capabilities"],
    image: "/placeholder.svg?height=400&width=600",
  },
  {
    id: "specialized",
    title: "Specialized Equipment",
    description: "Custom trailers and equipment for unique shipping requirements and challenging cargo.",
    features: [
      "Lowboy trailers for heavy machinery",
      "Double drop trailers",
      "Extendable trailers for extra-long loads",
    ],
    image: "/placeholder.svg?height=400&width=600",
  },
]
